...
| ---------------------------------- | ----------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------ |
| Featured products slider           | `FeaturedProducts.tsx`  | `<div class="slider-wrapper buttons-center---mbl w-slider">`      | Product images, arrow icons (font)                                                        | ⬜️     |
| Location spotlight (New York card) | `LocationSpotlight.tsx` | `<div class="w-layout-grid grid-2-columns location-image-right">` | `new-york-location-short-image-hair-x-webflow-template.jpg` plus address/phone/hours copy | ⬜️     |
