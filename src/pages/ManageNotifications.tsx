    ...
    <Section className="section">
      <Container className="inner-container _820px">
        <header className="text-center">
          <p className="eyebrow">Manage Notifications</p>
        ...
        <div className="mg-top-40px">
          ...
          <div className="card mg-top-32px" style={{ padding: '2rem' }}>
          ...
          <div className="card mg-top-32px" style={{ padding: '2rem' }}>
            ...
            <p className="paragraph-medium mg-top-12px">
              Email info@mukyala.com or call (760) 870-1087. We’ll honor unsubscribe requests within
              one business day while the automated experience rolls out.
            </p>
          </div>

          {status === 'submitted' && (
            <div
              className="card mg-top-24px"
              role="status"
              style={{ padding: '1.5rem', background: '#f3f4f6' }}
            >
